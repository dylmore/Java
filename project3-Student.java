...
//
// Comments/pseudocode by: Prof. Burger
//
// Code written by: Dylan Carey
//**************************************************************************************************
package proj3;
...
public class Student implements Comparable<Student> {
    ...
    public Student(String pFirstName, String pLastName) {
    	...
    	setExamList(mExamList = new ArrayList<>());
    	setHomeworkList(mHomeworkList = new ArrayList<>());
    }
    ...
    public int compareTo(Student pStudent) {
    	if(this.mLastName.compareTo(pStudent.mLastName) < 0) {return -1;}
    	else if(this.mLastName.compareTo(pStudent.mLastName) == 0) {return 0;}
    	else {return 1;}
    }
